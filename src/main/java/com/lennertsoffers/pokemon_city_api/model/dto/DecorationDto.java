...
public class DecorationDto extends BuildableDto {
    ...
    public DecorationDto(Long id, String name, int satisfactionModifier, int xpWhenFinished, int price, int unlockedAtLevel, int height, int width, Location location, BuildableTypeEnum buildableTypeEnum, DecorationType decorationType) {
